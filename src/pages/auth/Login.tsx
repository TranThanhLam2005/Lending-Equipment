                ...
                <FadeInSection>
                    <div className="bg-white rounded-lg shadow-lg flex flex-col md:flex-row overflow-hidden">
                        ...
                        <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
                            ...
                            <h2 className="text-center text-xl md:text-2xl text-dark-6 items-center mt-2 md:mt-10 mb-6">Login</h2>
                            ...
                            <input
                                ...
                                className={`${usernameCheck ? "mb-2" : "mb-4"} px-4 py-3 rounded-full bg-[#FDECEC] placeholder:text-[#F58989] text-[#F58989] text-xs md:text-base outline-none ${usernameCheck ? "ring-2 ring-red-400" : ""
                                    }`}
                            />
                            {usernameCheck && (
                                <p
