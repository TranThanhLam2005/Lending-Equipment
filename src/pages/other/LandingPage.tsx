    ...
    <div>
      <header className="fixed bg-white h-16 w-full flex items-center justify-between border-b-1 px-30 z-20">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button variant="primary" size="sm" onClick={() => navigate('/visitor')}>
            Visitor
          </Button>
        </div>
      </header>
        ...
        <FadeInSection>
          <div className="flex space-x-20 ">
            ...
            <div className="flex-1">
              <img src={Image} alt="Landing Image" className="w-full h-auto py-2 rounded-2xl border-1 shadow-2xl" />
            </div>
          </div>
        </FadeInSection>
        ...
        <FadeInSection>
          <div className="mt-30">
            ...
            <div className="flex flex-col items-center space-y-14 mt-10">
              ...
              {workComponent("4", "Join the Discussion & Share Feedback", "Engage with classmates by reviewing courses and equipment through the discussion board.", true)}
            </div>
          </div>
        </FadeInSection>
          ...
          <div className="mt-30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-10">
              ...
              <div className="w-88 shadow-xl rounded-2xl p-6 mt-10 bg-white">
                ...
                <p className="text-gray-700 ">A balanced experience for both students and instructors. Ideal for classroom use, registration booths, or on-site equipment check-ins with a clean, touch-friendly interface.</p>
              </div>
              <div className="w-88 shadow-xl rounded-2xl p-6 mt-10 bg-white">
                <h2 className="text-lg font-semibold mb-2">Mobile View</h2>
                <p className="text-gray-700 ">Quick and easy access for students on the go. Check your course schedule, request equipment, and stay updated — anytime, from anywhere.</p>
              </div>
            </div>
          </div>
        </FadeInSection>
        ...
        <FadeInSection>
          <div className="mt-30">
            ...
            <div className="flex flex-col items-center space-y-4 mt-10">
              ...
              {FAQComponent("Is EasyEd Track available on mobile devices?", "Absolutely. EasyEd Track is fully responsive and works seamlessly on desktops, tablets, and smartphones — so you can manage tasks anywhere, anytime.")}
            </div>
          </div>
        </FadeInSection>
  ...
  return (
    <div className="w-88 shadow-2xl rounded-2xl p-6 bg-white">
      <div className="flex  items-center mb-2">
        <img src={image} alt={name} className="w-16 h-16 rounded-full mb-4 mr-4" />
...
const FAQComponent = (question: string, answer: string) => {
  ...
  return (
    <div className="w-full shadow-xl rounded-2xl border-1 p-6 bg-white transition-all duration-200 ease-in-out">
      ...
      <div
        ref={contentRef}
        className={`transition-all duration-200 ease-in-out overflow-hidden ${isShowAnswer ? 'max-h-96 opacity-100 mt-3' : 'max-h-0 opacity-0'
          }`}
      >
